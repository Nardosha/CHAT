...
function printMessage(text) {
    ...
    const templateText = UI.MESSAGE_TEMPLATE.content.querySelector('.message__text')
    const templateUsername = UI.MESSAGE_TEMPLATE.content.querySelector('.message__user')
    const templateDate = UI.MESSAGE_TEMPLATE.content.querySelector('.message__time')
